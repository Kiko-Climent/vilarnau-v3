  ...
  useEffect(() => {
    ...
    preloadImages(images).then(() => {
      ...
      const interval = setInterval(() => {
        ...
        // actualiza el src directamente sin rerenderizar
        if (imgRef.current) {
    ...
    return () => clearInterval(); // cleanup por si acaso
  }, [startSlideshow]);
      ...
      {showFinalImage && (
        ...
        >
          ...
          >
            ...
            {isFinalText && (
              <div
                className="text-white text-sm md:text-base flex flex-col absolute top-1 left-2 md:right-2 items-start -space-y-[4px] md:-space-y-[6px]"
                ref={addressRef}
